  ...
  enable() {
    ...
    */
    this._timeoutId = setTimeout(() => {
      ...
      // Rebrand the built-in GNOME 'Auto Rotate' toggle to match our naming.
      const _builtinToggle = Main.panel.statusArea.quickSettings._autoRotate?.quickSettingsItems[0];
      if (_builtinToggle)
        _builtinToggle.title = 'YB AutoRotate';
